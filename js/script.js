const global = {
    ...
    //do not do this on live products - just for testing in local environment
    api: {
        apiKey: '542ff4ce8f90a24e70473fae77e0dc7c',
    ...
    results.forEach(movie => {
        ...
        div.innerHTML = `
                ...
                ${
                    ...
                    class="card-img-top"
                    alt="${movie.title} Thumbnail Image"
                    />`
                    : `<img
    ...
    results.forEach(result => {
        ...
        div.innerHTML = `
                ...
                ${
                    ...
                    class="card-img-top"
                    alt="${global.search.type === 'movie' ? result.title : result.name} Thumbnail Image"
                    />`
                    : `<img
                    src="images/no-image.jpg"
                    class="card-img-top"
...
function displayPagination(){
    ...
    // Disable prev & next button if on first page
...
async function fetchAPIData(endpoint){
    // Register your key at themoviedb.org/settings/api and enter here. Only use this for development or very small projects. You should store your key and make requests from a server.
    /* const API_KEY = '542ff4ce8f90a24e70473fae77e0dc7c';
